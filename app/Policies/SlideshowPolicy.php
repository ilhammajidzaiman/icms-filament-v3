...
class SlideshowPolicy
{
    ...
    {
        return $user->can('view-any Slideshow');
    }
    ...
    {
        return $user->can('view Slideshow');
    }
    ...
    {
        return $user->can('create Slideshow');
    }
    ...
    {
        return $user->can('update Slideshow');
    }
    ...
    {
        return $user->can('delete Slideshow');
    }
    ...
    {
        return $user->can('restore Slideshow');
    }
    ...
    {
        return $user->can('force-delete Slideshow');
    }
}
