...
class NavMenuPolicy
{
    ...
    {
        return $user->can('view-any NavMenu');
    }
    ...
    {
        return $user->can('create NavMenu');
    }
    ...
    {
        return $user->can('update NavMenu');
    }
    ...
    {
        return $user->can('delete NavMenu');
    }
    ...
    {
        return $user->can('restore NavMenu');
    }
    ...
    {
        return $user->can('force-delete NavMenu');
    }
}
